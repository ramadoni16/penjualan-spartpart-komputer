...
public class KeranjangBelanja extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newsList.clear();
        adapter = new AdapterTransaksi(KeranjangBelanja.this, newsList);
    ...
    public void onBackPressed() {
        Intent i = new Intent(KeranjangBelanja.this, HomePembeliActivity.class);
        startActivity(i);
        finish();
    }
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                        ...
                                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                            ...
                                            Intent a = new Intent(KeranjangBelanja.this, HomePembeliActivity.class);
